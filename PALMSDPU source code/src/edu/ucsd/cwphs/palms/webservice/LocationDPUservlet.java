...
public class LocationDPUservlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LocationDPUservlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String result = "Error: The LocationDPU Service only supports POST.";
	...
	private String process(String json){
		LocationDpu dpu = new LocationDpu();
